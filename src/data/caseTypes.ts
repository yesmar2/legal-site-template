export const caseTypes = [
  ...
  },
  {
    ...
    description:
      'Confidential, compassionate defense for domestic violence allegations. We understand the sensitive nature of these cases and work to protect your rights and reputation.',
  ...
  // Personal Injury
  {
    ...
    title: 'Car Accidents',
    description:
      'Representation for drivers and passengers injured in motor vehicle collisions, including rear-end, intersection, and highway crashes.',
  ...
  // Family Law
  {
    ...
    title: 'Divorce',
    description:
      'Guidance through contested and uncontested divorce, property division, and related financial issues.',
  ...
  // Real Estate
  {
    id: 'residential-closings',
    practiceSlug: 'real-estate-law',
    icon: 'home',
  ...
  },
  {
    ...
    description:
      'Legal support for commercial property purchases, sales, and leases for businesses and investors.',
